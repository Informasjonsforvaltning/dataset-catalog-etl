...
table_structure = {
    "field_data_field_access_rights": { "short": "ar", "valuefields": [{"valuefield" : "field_access_rights_target_id", "isnode" : True}]},
    "field_data_field_approved": { "short": "a", "valuefields": [{"valuefield": "field_approved_value", "isnode" : False}]},
    "field_data_field_category": { "short": "c", "valuefields": [{"valuefield": "field_category_tid", "isnode" : False}]},
    "field_data_field_data_contact_mail": { "short": "cm", "valuefields": [{"valuefield": "field_data_contact_mail_value", "isnode" : False}]},
    "field_data_field_data_contact_name": { "short": "cn", "valuefields": [{"valuefield": "field_data_contact_name_value", "isnode" : False}]},
    "field_data_field_data_description": { "short": "desc", "valuefields": [{"valuefield": "field_data_description_value", "isnode" : False}]},
    "field_data_field_data_resource": { "short": "r", "valuefields": [{"valuefield": "field_data_resource_url", "isnode": False}, {"valuefield": "field_data_resource_title", "isnode": False}]},
    "field_data_field_data_resources_data": { "short": "rd", "valuefields": [{"valuefield": "field_data_resources_data_url", "isnode": False}, {"valuefield": "field_data_resources_data_title", "isnode": False}]},
    "field_data_field_distribution": { "short": "dist", "valuefields": [{"valuefield": "field_distribution_target_id", "isnode" : True}]},
    "field_data_field_formatlist": { "short": "f", "valuefields": [{"valuefield": "field_formatlist_target_id", "isnode" : True}]},
    "field_data_field_geo": { "short": "geo", "valuefields": [{"valuefield": "field_geo_tid", "isnode" : False}]},
    "field_data_field_language": { "short": "lang", "valuefields": [{"valuefield": "field_language_target_id", "isnode" : True}]},
    "field_data_field_lisens": { "short": "lis", "valuefields": [{"valuefield": "field_lisens_licence", "isnode" : False}, {"valuefield":"field_lisens_name", "isnode" : False}, {"valuefield": "field_lisens_url", "isnode" : False}]},
    "field_data_field_los": { "short": "los", "valuefields": [{"valuefield": "field_los_tid", "isnode" : False }]},
    "field_data_field_organization": { "short": "o", "valuefields": [{"valuefield": "field_organization_nid", "isnode" : True}]},
    "field_data_field_user_org_ref": { "short": "uor", "valuefields": [{"valuefield": "field_user_org_ref_nid", "isnode" : True}]},
    "field_data_title_field": { "short": "tf", "valuefields": [{"valuefield": "title_field_value", "isnode": False}]}
}