...
# dataset 77
dataset_fields = [
{"name": "field_data_field_access_rights", "valuefield" : "field_access_rights_target_id", "isnode" : True},
{"name": "field_data_field_antall_datasett", "antall_datasett" : "field_antall_datasett_value", "isnode" : False},
{"name": "field_data_field_approved", "valuefield": "field_approved_value", "isnode" : False},
{"name": "field_data_field_category", "valuefield": "field_category_tid", "isnode" : False},
{"name": "field_data_field_data_contact_mail", "valuefield": "field_data_contact_mail_value", "isnode" : False},
{"name": "field_data_field_data_contact_name", "valuefield": "field_data_contact_name_value", "isnode" : False},
{"name": "field_data_field_data_description", "valuefield": "field_data_description_value", "isnode" : False},
{"name": "field_data_field_data_resource", "valuefields": [{"valuefield": "field_data_resource_url", "isnode": False}, {"valuefield": "field_data_resource_title", "isnode": False}]},
{"name": "field_data_field_data_resources_data", "valuefields": [{"valuefield": "field_data_resources_data_url", "isnode": False}, {"valuefield": "field_data_resources_data_title", "isnode": False}]},
{"name": "field_data_field_distribution", "valuefield": "field_distribution_target_id", "isnode" : True},
{"name": "field_data_field_formatlist", "valuefield": "field_formatlist_target_id", "isnode" : True},
{"name": "field_data_field_geo", "valuefield": "field_geo_tid", "isnode" : False},
{"name": "field_data_field_language", "valuefield": "field_language_target_id", "isnode" : True},
{"name": "field_data_field_lisens", "valuefields": [{"valuefield": "field_lisens_licence", "isnode" : False}, {"valuefield":"field_lisens_name", "isnode" : False}, {"valuefield": "field_lisens_url", "isnode" : False}]},
{"name": "field_data_field_los", "valuefield": "field_los_tid", "isnode" : False },
{"name": "field_data_field_organization", "valuefield": "field_organization_nid", "isnode" : True},
{"name": "field_data_field_user_org_ref", "valuefield": "field_user_org_ref_nid", "isnode" : True},
{"name": "field_data_title_field", "valuefield": "title_field_value", "isnode": False}
]