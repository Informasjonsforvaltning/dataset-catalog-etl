...
def load(transformed_json, c_type):
    total_updated = 0
    total_failed = 0
    fail_log = {}
    ...
    print("Total number of " + c_type + " updated: " + str(total_updated))
    print("Total number of " + c_type + " updates failed: " + str(total_failed))
    with open(args.outputdirectory + "load_errors_" + c_type + ".json", 'w', encoding="utf-8") as err_file:
